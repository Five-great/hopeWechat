// pages/hopeEducation/hopeEducation.js
Page({
  ...
  onLoad: function (options) {
    ...
    wx.Base.getData({flag:'dzb',id: 0,pageindex: this.data.pageIndex,pagesize: this.data.pageSize}).then(res=>{
  ...
  getShzrData(){
   ...
   if( (that.data.pageIndex-1)*that.data.pageSize<=that.data.pageTotal){
        wx.Base.getData({flag:'dzb',id: 0,pageindex: that.data.pageIndex,pagesize: that.data.pageSize}).then(res=>{
          that.data.pageIndex++;
